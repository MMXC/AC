...
> **LOGIC:** When building a specific page, first check `design-system/pages/[page-name].md` (or `design-system/watch-together/pages/[page-name].md`).
...
**Color Notes:** Calm Blue + Neutral grey
